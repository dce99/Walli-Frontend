...
export class IConnext__factory {
  ...
  static createInterface(): IConnextInterface {
    return new Interface(_abi) as IConnextInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IConnext {
    return new Contract(address, _abi, runner) as unknown as IConnext;
  }
}
